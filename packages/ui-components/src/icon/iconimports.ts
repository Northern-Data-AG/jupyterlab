...
import jupyterWhiteMoonsSvgstr from '../../style/icons/jupyter/jupyter-white-moons.svg';
import jupyterlabSvgstr from '../../style/icons/jupyter/jupyterlab.svg';
import jupyterlabWordmarkInverseSvgstr from '../../style/icons/jupyter/jupyterlab-wordmark-inverse.svg';
...
export const jupyterWhiteMoonsIcon = new LabIcon({ name: 'ui-components:jupyter-white-moons', svgstr: jupyterWhiteMoonsSvgstr });
export const jupyterlabIcon = new LabIcon({ name: 'ui-components:jupyterlab', svgstr: jupyterlabSvgstr });
export const jupyterlabWordmarkIcon = new LabIcon({ name: 'ui-components:jupyterlab-wordmark', svgstr: jupyterlabWordmarkSvgstr });
export const jupyterlabWordmarkInverseIcon = new LabIcon({ name: 'ui-components:jupyterlab-wordmark-inverse', svgstr: jupyterlabWordmarkInverseSvgstr });
